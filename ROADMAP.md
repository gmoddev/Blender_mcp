...
| 0I | Queue/job/content/selector bounds | Pathological selectors and resource floods fail without blocking Blender | In progress: provider jobs, network responses, archive expansion, and exact/prefix/suffix/glob name selectors are bounded and live-tested; provider-specific content bounds remain |
