...
| 0K | Disposable-profile Blender harness and supported-version matrix | Static scan gaps are reproduced and verified live | In progress: Blender 5.2.1 lifecycle, security-policy, provider, and filesystem harnesses pass; other supported versions and platforms remain |
