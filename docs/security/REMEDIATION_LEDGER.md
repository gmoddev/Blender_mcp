...
| 10 | Caller paths are normalized rather than authorized; force flags and prefix comparisons allow workspace escape/overwrite. | 0E | `fa393b9` (scene/export authority); `481f1a2` (sequencer media authority); `6a0914c` (render/capture containment); `802dd2a` (HDRI/headless containment); `e3e1b14` (motion-capture input authority); `db54c4d` (physics-cache containment); `510090a` (texture-bake output containment); `394ca05` (provider artifact containment) | Root absence, traversal, sibling-prefix, symlink, hardlink, ambiguous Windows syntax, extension/action mismatch, overwrite/sentinel, force-flag, sidecar-setting, cloud-pack/preview/multi-capture/headless/FBX/physics-cache/provider quarantine, sequencer/HDRI/BVH/cache/bake-output pre-mutation denial, approved BVH import, viewport final-sink reauthorization, redacted failures, dispatcher capability, direct-helper/low-level sink guards, and handler sink-order tests | Blender 5.2.1 passed disposable outside-root save/open/export/sequencer/HDRI/BVH/cache/bake/provider denial, approved save/overwrite/open/GLB export/sequencer image/HDRI/BVH import, sentinel preservation, Windows junction escape, and headless-render/FBX/physics-cache/texture-bake/provider no-output proof; windowed capture remains pending | **PARTIALLY ADDRESSED / BLOCKED** — scene/export, sequencer-media, primary viewport, HDRI, legacy headless-render, motion-capture, physics-cache, external texture-bake, and provider temporary-artifact paths are contained; full finding closure still requires remaining file sinks, atomic publication for string-path TOCTOU, mapped-volume enforcement, windowed capture, and supported POSIX validation |
